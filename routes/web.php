...
//Candidate
Route::get('/candidate',[CandidateController::class,'showCandidateHome']);
Route::get('/newcandidate',[CandidateController::class,'showCandidateCreate']);
Route::post('/postcandidate',[CandidateController::class,'createCandidate']);
Route::get('/delcandidate/{id}',[CandidateController::class,'deleteCandidate']);
Route::get('/edcandidate/{id}',[CandidateController::class,'updateCandidate']);
Route::put('/edcandidate/{id}',[CandidateController::class,'update']);